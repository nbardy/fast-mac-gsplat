...
ext_modules = [
    CppExtension(
        name="torch_gsplat_bridge_v5._C",
        sources=sources,
...
setup(
    name="torch-metal-gsplat-v5",
    version="0.1.0",
    description="Torch-native Metal projected Gaussian rasterizer v5 (batched + eval/train split)",
    packages=["torch_gsplat_bridge_v5"],
