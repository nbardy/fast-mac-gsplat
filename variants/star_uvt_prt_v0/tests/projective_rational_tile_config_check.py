...
def main() -> None:
    ...
    assert recommend_projective_rational_tile_config(tube_count=128).key == "8x8x2:128"
    assert recommend_projective_rational_tile_config(tube_count=256).key == "8x8x2:256"
