...
all-candidate insertion-sort/list work enough to beat PRT tiled: streamed
candidate blocks, band/window split passes, or a bounded candidate strategy
that avoids sorting every possible candidate per pixel.
