...
def main():
    ...
    active_tile_modes = [x for x in args.active_tile_modes.split(",") if x]
    ...
    rows = []
    for case, seed, batch_size, strategy, tile, chunk, cap, stop_mode, dense_threshold, active_tile_mode, sort_active_tile_mode in jobs:
        env = os.environ.copy()
        ...
        if active_tile_mode in ("off", "false", "0", "no"):
        ...
        print(
            ...
            f"active={active_tile_mode:3s} sort_active={sort_active_tile_mode:3s} "
