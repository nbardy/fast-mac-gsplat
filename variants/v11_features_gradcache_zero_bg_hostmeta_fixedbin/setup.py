...
ext_modules = [
    CppExtension(
        name="torch_gsplat_bridge_v11_features_gradcache_zero_bg_hostmeta_fixedbin._C",
        sources=sources,
...
setup(
    name="torch-metal-gsplat-v11-features-gradcache-zero-bg-hostmeta-fixedbin",
    version="0.1.0",
    description="Torch-native Metal projected Gaussian feature rasterizer with grad-cache and zero-background tail skip",
    packages=["torch_gsplat_bridge_v11_features_gradcache_zero_bg_hostmeta_fixedbin"],
