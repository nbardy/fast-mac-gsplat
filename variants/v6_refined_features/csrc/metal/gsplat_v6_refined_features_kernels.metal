...
kernel void v6_refined_features_count_tiles(
...
kernel void v6_refined_features_emit_binned_ids(
    const device float2* means2d [[buffer(0)]],
    const device float* conics [[buffer(1)]],
...
kernel void v6_refined_features_tile_fast_forward_eval(
...
kernel void v6_refined_features_tile_fast_forward_state(
    const device uint* tile_counts [[buffer(0)]],
    const device int* tile_offsets [[buffer(1)]],
...
kernel void v6_refined_features_tile_fast_backward_saved(
...
kernel void v6_refined_features_tile_overflow_forward(
...
kernel void v6_refined_features_tile_overflow_backward(
