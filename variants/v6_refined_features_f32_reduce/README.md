...
`v6_refined_features_f32_reduce` feature backend independently from the older
...
- Package: `torch_gsplat_bridge_v6_refined_features_f32_reduce`
...
- v6_refined_features_f32_reduce uses one generic feature-channel path. It does not stage feature
