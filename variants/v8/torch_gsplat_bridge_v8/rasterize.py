...
def _choose_batch_slices(
    ...
    *,
    ...
    for b0, b1 in base_slices:
        ...
        tile_counts, _, _ = torch.ops.gsplat_metal_v8.bin(
...
class _RasterizeProjectedGaussiansV8(torch.autograd.Function):
    ...
    def forward(
        ...
        if not hasattr(torch.ops, "gsplat_metal_v8"):
            raise RuntimeError("gsplat_metal_v8 custom ops not found. Build the extension first.")
        ...
        tile_counts, tile_offsets, binned_ids = torch.ops.gsplat_metal_v8.bin(
        ...
        if resolved_use_active_tiles:
            ...
            out_fast, tile_stop_counts = torch.ops.gsplat_metal_v8.render_active_forward_state(
                means_flat,
                conics_flat,
                colors_flat,
                opacities_flat,
            ...
            out_fast, tile_stop_counts = torch.ops.gsplat_metal_v8.render_fast_forward_state(
                means_flat,
                conics_flat,
                colors_flat,
                opacities_flat,
        ...
        if enable_overflow_fallback:
            ...
            if overflow_tile_ids.numel() > 0:
                overflow_tile_imgs = torch.ops.gsplat_metal_v8.render_overflow_forward(
                    means_flat,
                    conics_flat,
                    colors_flat,
                    opacities_flat,
    ...
    def backward(ctx, grad_out: Tensor):
        ...
        if ctx.use_active_tiles:
            g_means_flat, g_conics_flat, g_colors_flat, g_opacities_flat = torch.ops.gsplat_metal_v8.render_active_backward_saved(
                grad_fast,
                means_flat,
                conics_flat,
                colors_flat,
            ...
            g_means_flat, g_conics_flat, g_colors_flat, g_opacities_flat = torch.ops.gsplat_metal_v8.render_fast_backward_saved(
                grad_fast,
                means_flat,
                conics_flat,
                colors_flat,
        ...
        if ctx.enable_overflow_fallback and overflow_tile_ids.numel() > 0:
            ...
            go_means, go_conics, go_colors, go_opacities = torch.ops.gsplat_metal_v8.render_overflow_backward(
                grad_tiles,
                means_flat,
                conics_flat,
                colors_flat,
...
def _rasterize_chunk_eval(
    ...
    if resolved_use_active_tiles:
        ...
        out_fast = torch.ops.gsplat_metal_v8.render_active_forward_eval(
            means_flat,
            conics_flat,
            colors_flat,
            opacities_flat,
        ...
        out_fast = torch.ops.gsplat_metal_v8.render_fast_forward_eval(
            means_flat,
            conics_flat,
            colors_flat,
            opacities_flat,
    ...
    *,
    ...
    for b0, b1 in batch_slices:
        ...
        if run_forward or return_image:
            ...
            if resolved_use_active_tiles:
                _, stop_counts = torch.ops.gsplat_metal_v8.render_active_forward_state(
                    m_s,
                    q_s,
                    c_s,
                    o_s,
                ...
                _, stop_counts = torch.ops.gsplat_metal_v8.render_fast_forward_state(
                    m_s,
                    q_s,
                    c_s,
                    o_s,
