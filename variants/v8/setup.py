...
ext_modules = [
    CppExtension(
        name="torch_gsplat_bridge_v8._C",
        sources=sources,
...
setup(
    name="torch-metal-gsplat-v8",
    version="0.1.0",
    description="Torch-native Metal projected Gaussian rasterizer v8 (batch-first + active-tile scheduling)",
    packages=["torch_gsplat_bridge_v8"],
