...
from torch_gsplat_bridge_v9_hw_tile_state import (
    estimate_tile_state_memory,
    probe_hw_interop,
...
def main() -> None:
    ...
    estimate = estimate_tile_state_memory(height=2160, width=3840, tile_size=16)
    print(json.dumps({"tile_state_4k_estimate": estimate}, indent=2, sort_keys=True))
    ...
    if status.tile_execution_probe_available:
        tile_probe = run_tile_state_execution_probe(32, 32, 32)
