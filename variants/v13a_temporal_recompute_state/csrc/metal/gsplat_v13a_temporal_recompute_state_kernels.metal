...
kernel void v13a_temporal_recompute_state_count_tiles(
...
kernel void v13a_temporal_recompute_state_init_fixed_bin_offsets(
...
kernel void v13a_temporal_recompute_state_emit_binned_ids(
    const device float2* means2d [[buffer(0)]],
    const device float* conics [[buffer(1)]],
...
kernel void v13a_temporal_recompute_state_tile_fast_forward_eval(
...
kernel void v13a_temporal_recompute_state_tile_fast_forward_state(
    const device uint* tile_counts [[buffer(0)]],
    const device int* tile_offsets [[buffer(1)]],
...
kernel void v13a_temporal_recompute_state_tile_fast_backward_saved(
...
kernel void v13a_temporal_recompute_state_tile_active_forward_eval(
...
kernel void v13a_temporal_recompute_state_tile_active_forward_state(
    const device uint* active_tile_ids [[buffer(0)]],
    const device uint* tile_counts [[buffer(1)]],
    const device int* tile_offsets [[buffer(2)]],
...
kernel void v13a_temporal_recompute_state_tile_active_backward_saved(
    const device float* grad_features [[buffer(0)]],
    const device float* grad_alpha [[buffer(1)]],
...
kernel void v13a_temporal_recompute_state_tile_overflow_forward(
...
kernel void v13a_temporal_recompute_state_tile_overflow_backward(
