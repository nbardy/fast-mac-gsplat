...
from torch_gsplat_bridge_v13a_temporal_recompute_state import (
    RasterConfig,
...
def main():
    ...
    p.add_argument("--backward-state-strategy", choices=("save", "recompute"), default="save")
    ...
    cfg = RasterConfig(
        ...
        backward_state_strategy=args.backward_state_strategy,
    )
