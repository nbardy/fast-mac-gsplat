...
ext_modules = [
    CppExtension(
        name="torch_gsplat_bridge_v6_refined_features_f64_accum64._C",
        sources=sources,
...
setup(
    name="torch-metal-gsplat-v6-refined-features-f64-accum64",
    version="0.1.0",
    description="Torch-native Metal projected Gaussian feature rasterizer v6 refined feature namespace",
    packages=["torch_gsplat_bridge_v6_refined_features_f64_accum64"],
