...
BENCHMARKS = {
    "v12b_raster_scaffold": THIS_BENCH,
    "f32_accum": F32_ACCUM_BENCH,
    "f64_accum64": F64_ACCUM64_BENCH,
    "stable_v6_refined_features": STABLE_BENCH,
}
FREEZE_COLOR_VARIANTS = {"v12b_raster_scaffold", "f32_accum", "f64_accum64"}
...
def main() -> None:
    p = argparse.ArgumentParser(
        description=(
            "Safe sequential benchmark matrix for the v12b_fused_colorize_rmsnorm_l1 fork. "
    ...
    p.add_argument("--variants", type=str, default="v12b_raster_scaffold")
    ...
    p.add_argument(
        "--freeze-colors",
        action="store_true",
        help="Only benchmark variants where feature/color tensors do not require gradients.",
    )
