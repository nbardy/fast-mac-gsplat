...
import torch_gsplat_bridge_v12c_fused_raster_color_loss_backward.rasterize as v5_rasterize
from torch_gsplat_bridge_v12c_fused_raster_color_loss_backward import RasterConfig, rasterize_projected_gaussians
