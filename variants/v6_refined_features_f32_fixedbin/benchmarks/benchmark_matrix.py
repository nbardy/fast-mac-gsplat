...
def main() -> None:
    p = argparse.ArgumentParser(
        description=(
            "Safe sequential benchmark matrix for the v6_refined_features_f32_fixedbin fork. "
    ...
    p.add_argument("--variants", type=str, default="f32_fixedbin")
    ...
    p.add_argument(
        "--freeze-colors",
        action="store_true",
        help="Only benchmark the f32_fixedbin fork path where feature/color tensors do not require gradients.",
    )
