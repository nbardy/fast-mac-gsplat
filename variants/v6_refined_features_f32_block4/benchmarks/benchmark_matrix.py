...
FREEZE_COLOR_VARIANTS = {"f32_block4", "f32_accum", "f64_accum64", "f32_gradcache"}
...
def main() -> None:
    p = argparse.ArgumentParser(
        description=(
            "Safe sequential benchmark matrix for the v6_refined_features_f32_block4 fork. "
    ...
    p.add_argument("--variants", type=str, default="f32_block4")
    ...
    p.add_argument(
        "--freeze-colors",
        action="store_true",
        help="Only benchmark the f32_block4 fork path where feature/color tensors do not require gradients.",
    )
