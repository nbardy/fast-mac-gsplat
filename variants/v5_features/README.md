# torch-metal-gsplat-v5-features
...
This is a fork of `variants/v5`. The original v5 package and
`torch.ops.gsplat_metal_v5` namespace are intentionally untouched for RGB
baseline and parity testing.

## Feature Contract

- Package: `torch_gsplat_bridge_v5_features`
...
- v5_features uses one generic feature-channel path. It does not stage feature
...
- Keep original v5 for RGB-only baseline training; use this fork when callers
  need rasterized feature maps before a colorizer.
