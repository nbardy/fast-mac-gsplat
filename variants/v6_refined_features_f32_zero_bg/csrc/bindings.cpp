...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.bin: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_fast_forward_eval: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_fast_forward_state: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_fast_backward_saved: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_active_forward_eval: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_active_forward_state: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_active_backward_saved: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_overflow_forward: no backend available for device ", means2d.device());
}
...
#endif
  TORCH_CHECK(false, "gsplat_metal_v6_refined_features_f32_zero_bg.render_overflow_backward: no backend available for device ", means2d.device());
}

}  // namespace
}  // namespace gsplat

TORCH_LIBRARY(gsplat_metal_v6_refined_features_f32_zero_bg, m) {
...
TORCH_LIBRARY_IMPL(gsplat_metal_v6_refined_features_f32_zero_bg, CompositeExplicitAutograd, m) {
