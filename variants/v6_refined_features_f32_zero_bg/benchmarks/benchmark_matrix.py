...
FREEZE_COLOR_VARIANTS = {"f32_zero_bg", "f32_accum", "f64_accum64", "f32_gradcache", "f32_block4", "f32_fixedbin"}
...
def main() -> None:
    p = argparse.ArgumentParser(
        description=(
            "Safe sequential benchmark matrix for the v6_refined_features_f32_zero_bg fork. "
    ...
    p.add_argument("--variants", type=str, default="f32_zero_bg")
    ...
    p.add_argument(
        "--freeze-colors",
        action="store_true",
        help="Only benchmark the f32_zero_bg fork path where feature/color tensors do not require gradients.",
    )
