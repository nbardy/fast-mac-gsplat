...
REDUCE_BENCH = HERE.parents[1] / "v6_refined_features_f32_reduce" / "benchmarks" / "benchmark_mps.py"
...
def main() -> None:
    p = argparse.ArgumentParser(
        description=(
            "Safe sequential benchmark matrix for the v6_refined_features_f32_stage fork. "
    ...
    p.add_argument("--include-reduce-baseline", action="store_true")
    ...
    variants = [("f32_stage", THIS_BENCH)]
    if args.include_reduce_baseline:
        variants.append(("f32_reduce", REDUCE_BENCH))
